...
Write-Host -ForegroundColor Green "[+] Function Install-CMTrace"
...
$text={get-windowsautopilotinfo.ps1 -Online -Assign -groupTag $grouptag -TenantId "c3e96bd4-6b32-4bf0-9770-c830983b5d7a" -AppId "41271e57-378c-4210-b274-7c08282f68d2" -AppSecret ".Ey8Q~wLX-LuhxBRu-1_tE92aGWF~W3iaLhndbk0"
Stop-Computer}
